...
async function bootstrap() {
    ...
    const tagRepo = app.get((0, typeorm_1.getRepositoryToken)(tag_entity_1.Tag));
    const articleRepo = app.get((0, typeorm_1.getRepositoryToken)(article_entity_1.Article));
...
React 19 带来了许多令人兴奋的新特性和改进，特别是并发渲染和自动批处理，将显著提升应用的性能和用户体验。建议开发者尽快熟悉这些新特性，并在新项目中采用它们。`,
            ...
            tags: [savedTags[0], savedTags[3], savedTags[10]],
        },
        {
...
Next.js 15 提供了强大的全栈开发能力，通过 Server Actions、App Router 和流式渲染等特性，我们可以构建出高性能、用户体验优秀的现代 Web 应用。`,
            ...
            commentCount: 95,
            category: savedCategories[0],
            tags: [savedTags[2], savedTags[3], savedTags[11]],
        },
        {
...
NestJS 提供了强大的企业级特性，通过模块化架构、依赖注入和完整的 TypeScript 支持，我们可以构建出高性能、可维护的 RESTful API。`,
            ...
            tags: [savedTags[5], savedTags[6], savedTags[11]],
        },
        {
...
Docker 容器化技术为应用部署提供了标准化、可移植的解决方案。通过合理使用 Dockerfile、Docker Compose 和 Kubernetes，我们可以实现高效的容器化部署。`,
            ...
            tags: [savedTags[7], savedTags[8], savedTags[11]],
        },
        {
...
Kubernetes 提供了强大的容器编排能力，通过合理使用 Deployment、Service、Ingress 等资源，我们可以构建出高可用、可扩展的云原生应用。`,
            ...
            commentCount: 88,
            category: savedCategories[2],
            tags: [savedTags[8], savedTags[9], savedTags[11]],
        },
    ];
